...
public class WindowEnumerator
{
    ...
    public class Rectangle
    {
        ...
        public int Width;
        public int Height;
        public Rectangle(int rectLeft, int rectTop, int w, int h)
        {
            Left = rectLeft;
            Top = rectTop;
            Width = w;
...
{
    public WindowInfo(IntPtr hWnd, string className, string title, bool isVisible, WindowEnumerator.Rectangle bounds)
    {
        Hwnd = hWnd;
        ClassName = className;
        Title = title;
    ...
    public WindowInfo() 
    {
        ...
        Title = "";
        IsVisible = false;
        Bounds = new WindowEnumerator.Rectangle(0, 0, 0, 0);
    }
    ...
    /// 获取窗口当前的位置和尺寸。
    /// </summary>
    public WindowEnumerator.Rectangle Bounds { get; }
    ...
    public bool IsVaild => Hwnd != IntPtr.Zero;
}