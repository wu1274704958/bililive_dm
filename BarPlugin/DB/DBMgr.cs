...
#if DEBUG
                .UseConnectionString(FreeSql.DataType.Sqlite, @"Data Source=E:/Aoe4DB/bar_game_openid_test.db")
#else
                .UseConnectionString(FreeSql.DataType.Sqlite, @"Data Source=E:/Aoe4DB/bar_game_openid.db")
#endif
